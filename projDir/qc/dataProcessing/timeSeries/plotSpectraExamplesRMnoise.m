...
text(velX(1)-10,-57.5,{['Time domain:']; ...
    ['WIDTH: ',num2str(momentsTime.width(rangeInd,ii),2),' ms^{-1}']; ...
    ['SKEW: ',num2str(momentsTime.skew(rangeInd,ii),2)]; ...
    ['KURT: ',num2str(momentsTime.kurt(rangeInd,ii),2)]});
