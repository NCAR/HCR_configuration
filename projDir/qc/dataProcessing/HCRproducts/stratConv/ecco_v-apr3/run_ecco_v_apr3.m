...
startTime=datetime(2022,9,6,14,14,0);
endTime=datetime(2022,9,6,14,19,0);

meltAlt=2.9; % Estimated altitude of melting layer in km
divAlt=8; % Estimated altitude of divergence level in km

dataDir='/scr/virga1/rsfdata/projects/nasa-apr3/data/3D/';

figdir='/scr/virga1/rsfdata/projects/nasa-apr3/figs/';
