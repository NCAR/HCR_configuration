...
grid on
box on
text(datetime(2019,9,27,12,32,10),14,'(d) Basic convective/stratiform partitioning','FontSize',11,'FontWeight','bold');
...
grid on
box on
text(datetime(2019,9,27,12,32,10),14,'(e) Convective/stratiform partitioning','FontSize',11,'FontWeight','bold');
