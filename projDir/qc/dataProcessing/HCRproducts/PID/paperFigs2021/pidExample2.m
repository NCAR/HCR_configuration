...
startTime=datetime(2018,1,16,2,15,0);
endTime=datetime(2018,1,16,2,33,0);
...
cb1.Ticks=-30:10:10;
ylabel('Altitude (km)');
text(startTime+seconds(5),ylimits(2)-0.27,'(a) DBZ (dBZ)',...
...
cb2.Ticks=-4:2:4;
ylabel('Altitude (km)');
text(startTime+seconds(5),ylimits(2)-0.32,'(b) VEL (m s^{-1})',...
    'fontsize',11,'fontweight','bold','BackgroundColor','w','Margin',0.5);
...
cb3.Ticks=-25:5:-10;
ylabel('Altitude (km)');
text(startTime+seconds(5),ylimits(2)-0.27,'(c) LDR (dB)',...
    'fontsize',11,'fontweight','bold','BackgroundColor','w','Margin',0.5);
grid on
box on
s3.XTickLabel=[];
...
ylabel('Altitude (km)');
text(startTime+seconds(5),ylimits(2)-0.32,'(d) WIDTH (m s^{-1})',...
    'fontsize',11,'fontweight','bold','BackgroundColor','w','Margin',0.5);
...
cb5.Ticks=-8:2:8;
ylabel('Altitude (km)');
text(startTime+seconds(5),ylimits(2)-0.27,['(e) TEMP ',char(176),'C'],...
    'fontsize',11,'fontweight','bold','BackgroundColor','w','Margin',0.5);
...
ylabel('Altitude (km)');
text(startTime+seconds(5),ylimits(2)-0.27,'(f) ICING',...
    'fontsize',11,'fontweight','bold','BackgroundColor','w','Margin',0.5);
...
ylabel('Altitude (km)');
text(startTime+seconds(5),ylimits(2)-0.27,'(g) PID',...
    'fontsize',11,'fontweight','bold','BackgroundColor','w','Margin',0.5);
grid on
box on
s7.YTick=0:0.5:2.5;
...
print(fig1,[figdir,'pidExample2.png'],'-dpng','-r0')
