...
if cloudParams.meanLat<-65 & cloudParams.meanBaseTemp<-30 & cloudParams.meanTopTemp<-35
    ...
    % algorithm
elseif cloudParams.inhomo<0.5 & cloudParams.maxAgl<3 & cloudParams.meanMinAgl<1.8 % CloudSat checks also cloud fracion and intense_prep_flag
    cloudFlag=5;
elseif cloudParams.inhomo>0.3 & cloudParams.maxAgl>3 & cloudParams.minTopTemp>-35 & ...
        ...
        (cloudParams.meanMinAgl>1 | (cloudParams.meanMinAgl>1 & cloudParams.maxAgl>3.5) | ...
...
elseif cloudParams.meanThickness>8 & cloudParams.meanMaxRefl<0
    cloudFlag=6;
elseif (cloudParams.meanThickness>2 | cloudParams.maxAgl>=3) & ...
        cloudParams.meanThickness<7 & cloudParams.meanMaxRefl>0 & cloudParams.lengthKM<100 % Cloudsat also checks for intense_prep_flag
    cloudFlag=3;
