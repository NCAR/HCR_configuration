...
for aa=1:length(caseStart)
    ...
    for bb=1:length(fileListTS)
        ...
        for ii=1:beamNum
            ...
            [momentsVelDualRawOne,momentsPowerDualRawOne]=findDualVels(powerRMnoiseDBsmooth,specVelRMnoise,specPowerDBadj,momentsVelDualRawOne,momentsPowerDualRawOne,ii);
