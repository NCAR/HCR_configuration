...
directories.figdir='/h/eol/romatsch/hcrCalib/oceanScans/figs/socratesRaw_dBm/';
...
[outTableFast PLTFast]=f_processOceanScans_dBm(directories,infileF,makeSingleFigs,projectNameF);

% Slow scans
infileS='/h/eol/romatsch/hcrCalib/oceanScans/biasInFiles/cal_SOCRATES_slow.txt';
projectNameS='slowSOCRATES';

[outTableSlow PLTSlow]=f_processOceanScans_dBm(directories,infileS,makeSingleFigs,projectNameS);
