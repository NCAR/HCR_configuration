function myXtickResize(src,evnt);

global h;
% h is an array of subplot handles

% note that the function callback requires two arguments
% (src,event), but that those arguments can be ignored if the
% essential info exists in a global variable, like h.
