...
% 10/04/2019: Fixed error regarding nested function (ML behavior changed;
%             this warned in 2019a, errored in 2019b)
...
tabCardPosn = [];%This should address an issue with defining tabCardPosn in a subfunction.
