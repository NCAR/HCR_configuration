...
t = tiledlayout(4,1,'TileSpacing','tight','Padding','compact','TileIndexing', 'columnmajor');
...
dftcorr=cat(2,spectra.fftCorr(495:end),spectra.fftCorr(1:494));

hold on

l1=plot(xdata,dftcorr,'-g','LineWidth',2);
%ylabel('Power (dB)');
%ylim([-80,-20]);
xlim(xlim2);
...
box on
%title('(a) Example spectrum')
legend([l1],{'DFT_{cf}'},'Location','northwest');
text(555,730,'(c)','FontSize',12,'FontWeight','bold')
...
text(920,-25,'(d)','FontSize',12,'FontWeight','bold')
