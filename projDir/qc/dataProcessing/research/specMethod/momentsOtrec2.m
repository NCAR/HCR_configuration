...
load([figdir,'highMomentExample_otrec2.mat']);
load([figdir,'highMomentExample_otrec2_cf.mat']);

[ia,ib]=intersect(datenum(dataCF.time),datenum(momentsSpecSmoothCorr.time));

dataCF.DBZ=dataCF.DBZ(:,ib);
dataCF.VEL_MASKED=dataCF.VEL_MASKED(:,ib);
dataCF.SNR=dataCF.SNR(:,ib);
...
xlims=[datetime(2019,9,17,16,17,30),datetime(2019,9,17,16,21,55)];
ylims=[9,14];
...
print(f1,[figdir,'momentsOTREC2.png'],'-dpng','-r0');