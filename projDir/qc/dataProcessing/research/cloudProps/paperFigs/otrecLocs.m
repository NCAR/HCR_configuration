...
classTypeNames={'(a) CloudLow','(b) CloudMid','(c) CloudHigh',...
    ...
    '(d) ConvYoungShallow','(e) ConvYoungMid','(f) ConvYoungDeep',...
    '(g) ConvMatureShallow','(h) ConvMatureMid','(i) ConvMatureDeep'};
...
print([figdir,'otrec_locs.png'],'-dpng','-r0');
