...
for aa=1:length(caseStart)
    ...
    puzz.(fieldsP{aa})=data.DBZ_MASKED;
...
ax1.Position=[0.047,0.57,0.42,0.41];
ax2.Position=[0.506,0.57,0.42,0.41];
ax3.Position=[0.047,0.08,0.92,0.41];
cb.Position=[0.93,0.57,0.0178,0.41];

formatOut = 'yyyymmdd_HHMM';
set(gcf,'PaperPositionMode','auto')
print([figdir,'cloudPuzzle_refl_steps.png'],'-dpng','-r0');
