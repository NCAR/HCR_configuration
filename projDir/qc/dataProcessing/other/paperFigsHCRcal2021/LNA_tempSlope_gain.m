...
figdir=['/home/romatsch/plots/HCR/other/'];

indir='/run/media/romatsch/RSF0006/rsf/hcr/socrates/100hz/'; %socrates
...
for ii=24:24
    ...
    for jj=1:size(fileList,2)
        ...
        if inlist{ii,13}==0 | inlist{ii,13}==3 %If low res temperature is required, read it from the cfradial file
            ...
            RecGain=[RecGain ncread(fileList{jj},'r_calib_receiver_gain_vc')];
        end
