...
// Benchtop Cal dated 09192019 (Tsai) Pout = 59.91 dBm
//
// Type: double
//

// xmitPowerDbmV = 59.91;
xmitPowerDbmV = 60.27; // spicule
...
output_dir = "$(PROJ_DIR)/calibration/data/wband_256ns";
